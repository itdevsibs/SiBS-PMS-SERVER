...
const PROFILE_FIELD_MAPPINGS = {
  [IMPORT_PROFILE_CODES.FUSECOM_AGENT_LEVEL]: {
    ...
    talk_seconds: ["Duration (sec)", "Duration", "Talk Time", "Talk Time (sec)", "Talk Seconds"],
    ...
    handle_seconds: ["Handle Time", "Handle Time (sec)", "Handle Seconds", "Duration (sec)", "Duration"],
  ...
  [IMPORT_PROFILE_CODES.FUSENET_AGENT_LEVEL]: {
    ...
    talk_seconds: ["Duration (sec)", "Duration", "Talk Seconds", "Talk Time"],
    hold_seconds: ["Total Hold Time (sec)", "Hold Seconds", "Hold Time"],
    after_call_seconds: ["ACW Seconds", "After Call Seconds", "After Call Time"],
    handle_seconds: ["Handle Seconds", "Handle Time", "Duration (sec)", "Duration"],
  ...
  [IMPORT_PROFILE_CODES.HERODASH_AGENT_LEVEL]: {
    ...
    queue_seconds: ["Queue Time (sec)", "Queue Seconds"],
    talk_seconds: ["Duration (sec)", "Duration", "Talk Time (sec)", "Talk Seconds"],
    ...
    handle_seconds: ["Handle Time (sec)", "Handle Seconds", "Duration (sec)", "Duration"],
